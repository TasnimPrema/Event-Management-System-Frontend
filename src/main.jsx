...
const router = createBrowserRouter([
  {
    ...
    children: [
...

      {
        ...
        loader: () => fetch('http://localhost:9090/getAllService') // do not load all data. load only what you need
      },

      {
        ...
        loader: () => fetch('http://localhost:9090/getServiceById/{id}') // do not load all data. load only what you need
      },
      {
        path: '*',
